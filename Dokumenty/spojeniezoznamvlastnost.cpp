...
SpojenieZoznamVlastnost::SpojenieZoznamVlastnost(QString nazov, Komponenty::Komponent *spojenie, std::vector<Komponenty::Komponent *> hodnota)
...
void SpojenieZoznamVlastnost::setHodnota(std::vector<Komponenty::Komponent *> hodnota)
{
    _hodnota = hodnota;
}
